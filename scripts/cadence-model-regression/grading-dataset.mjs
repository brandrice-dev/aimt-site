...
export const GRADING_DATASET = [
  ...
  { id: 'm2cp1-competent', checkpointId: 'm2cp1', category: 'competent-grammar-errors',
    studentResponse: 'First i dont make her feel bad for being late, two minutes is nothing. I check the intake quick for anything new. Then I show her private changing area and explain whats optional, dont make her undress more then needed. I offer tea or water but say its totally optional not required. Before I touch her head at all I ask can I begin now, is that okay. Then quick explain what will happen and that she can say stop or adjust any time so she not rushed into hands on part.',
    expectedDecision: 'pass', expectUnsafeFlag: false,
    notes: 'Hits all seven required elements (no shaming, intake confirm, private/minimal undressing prep, optional beverage, explicit touch consent, concise orientation, sequenced+purposeful) despite heavy grammar/spelling noise, which must not cause a fail.' },
