/* ═══════════════════════════════════════════════════════════════
   ...
   LAUNCH UPDATE: this route is now live (education/hair-loss/
   hair-growth-cycle.html), with education.html (/education) and
   education/hair-loss.html (/education/hair-loss) as its real library-
   landing and topic-hub parents -- see sitemap.xml, which now lists all
   three. This file's `related_links` are still hand-verified against
   the actual filesystem/sitemap on every edit, never an invented
   sibling page -- that discipline doesn't relax just because a route
   graduated from planned to live.
   ═══════════════════════════════════════════════════════════════ */
