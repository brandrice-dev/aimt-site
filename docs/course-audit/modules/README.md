...
| Migration plan | [`module-09-reorder-migration-plan.md`](module-09-reorder-migration-plan.md) — **proposed, awaiting external review/approval** — the sole remaining gate before implementation authority |
