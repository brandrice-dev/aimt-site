...
**Final Exam design phase begun (August 26, 2026) — architecture and content extraction only, not implementation.** With Module 11 closed out, the Final Exam design phase authorized by `00-global-decisions.md`'s "Course sequence & Final exam" section has begun. Two new documents govern it: [`../00-aimt-certification-assessment-standard.md`](../00-aimt-certification-assessment-standard.md) (AIMT Certification & Assessment Standard, Version 1 — the institutional, course-agnostic philosophy, three-part assessment model, pass standard, remediation ladder, and integrity/architecture requirements every AIMT certification course's final assessment must follow) and [`module-12-final-exam-raw-blueprint.md`](module-12-final-exam-raw-blueprint.md) (a competency map extracted from Modules 1–11, 80 raw candidate knowledge questions, 8 raw candidate applied cases, 8 raw candidate Cadence exit-interview prompts, the Module 12 state architecture, a randomization approach, and a list of open owner decisions). Both are raw/architectural — no student-facing exam language is final, and this table's status line is unchanged by this phase.

**Next gate:** owner/external review of the certification standard and raw blueprint, followed by a final exam-language rewrite outside this repository's Claude-authored documentation — only after that may Module 12 implementation itself be authorized as a separate, later task. Do not begin implementation from this entry.
