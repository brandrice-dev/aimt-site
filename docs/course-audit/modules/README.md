...
| Approved specification file | [`module-09.md`](module-09.md) — **approved in substance**, five narrow amendments applied; curriculum direction is locked |
| Migration plan | [`module-09-reorder-migration-plan.md`](module-09-reorder-migration-plan.md) — **approved migration design candidate, ready for final external approval** — two narrow corrections applied; final sign-off is the sole remaining gate before implementation authority |
...
| **Status** | **Approved curriculum specification — implementation blocked pending migration-plan approval.** Curriculum content is locked. NOT implemented, NOT manually QA'd, NOT approved for release. |
