...
**AMENDED August 24, 2026 — silence is taught explicitly, not by omission.** A chapter where the default should be quiet does not simply have an empty field; it carries a **"Keep this quiet"** explanation of why narration is unnecessary here, plus an **"If they ask"** response so the student still has an accurate, ready answer if the client does ask. As of this amendment: Video 03 (Dry Brushing), Video 05's rinse portion, and Video 07 (Shampoo & Rinse) use this quiet form; every other chapter carries a direct spoken cue. See "Approved video chapter architecture" and this document's final communication-cue amendment above.
